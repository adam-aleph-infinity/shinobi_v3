    ...
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 relative" ref={canvasContainerRef} onDrop={onDrop} onDragOver={onDragOver}>
          ...
          {showCallsPanel && (
            <div className="absolute inset-0 z-40 bg-black/55 backdrop-blur-[1px] p-3 flex items-center justify-center">
              <div
                className="relative w-[min(95vw,1500px)] h-[min(90vh,920px)] rounded-xl border border-indigo-800/45 bg-gray-950/94 shadow-[0_32px_90px_rgba(0,0,0,0.68)] overflow-visible"
          ...
          {showCrmPanel && (
            <div className="absolute inset-0 z-40 bg-black/55 backdrop-blur-[1px] p-3 flex items-center justify-center">
              <div
                className="relative w-[min(95vw,1500px)] h-[min(90vh,920px)] rounded-xl border border-cyan-800/45 bg-gray-950/94 shadow-[0_32px_90px_rgba(0,0,0,0.68)] overflow-visible"
                style={{ animation: "canvasPopupIn 180ms ease-out" }}
              >
                <button
          ...
          {selectedNodeId && (
            <div className="absolute inset-0 z-30 bg-black/55 backdrop-blur-[1px] p-3 flex items-center justify-center">
              <div
                className="relative w-[min(95vw,1500px)] h-[min(90vh,920px)] rounded-xl border border-indigo-700/45 bg-gray-900/94 backdrop-blur-sm shadow-[0_32px_90px_rgba(0,0,0,0.68)] overflow-visible flex flex-col"
                style={{ animation: "canvasPopupIn 180ms ease-out" }}
              >
                <button
