...
import {
  ...
  FolderOpen, Bot, PanelLeftClose, Settings, StickyNote, DatabaseZap, Layers, GitBranch,
} from "lucide-react";
...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/workflow", icon: Layers,    label: "Workflow (old)" },
      { href: "/test",     icon: Layers,    label: "Pipeline Test (old)" },
    ],
  },
  {
    label: "Analyze",
